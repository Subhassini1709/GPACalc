...
public class Sem7_Activity extends AppCompatActivity {
    EditText m1,m2,m3,m4,m5,m6,m7;
    Button calc,reset;
    String s1,s2,s3,s4,s5,s6,s7;
    float n1,n2,n3,n4,n5,n6,n7,sgpa;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m1 = findViewById(R.id.sem7_1);
        m2 = findViewById(R.id.sem7_2);
        m3 = findViewById(R.id.sem7_3);
        m4 = findViewById(R.id.sem7_4);
        m5 = findViewById(R.id.sem7_5);
        m6 = findViewById(R.id.sem7_6);
        m7 = findViewById(R.id.sem7_7);
        calc = findViewById(R.id.calc_sem7);
        reset = findViewById(R.id.reset_sem7);
        ...
        calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sgpa = (float) ((n1*4 + n2*4 + n3*3 + n4*3 + n5*3 + n6*2 + n7*1)/20.0);
                String result = String.format(Locale.US,"%.2f",sgpa);

                Bundle bundle = new Bundle();
                bundle.putString("name", "SGPA for 7th SEM");
