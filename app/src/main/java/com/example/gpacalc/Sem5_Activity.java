...
public class Sem5_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m1 = findViewById(R.id.sem5_1);
        m2 = findViewById(R.id.sem5_2);
        m3 = findViewById(R.id.sem5_3);
        m4 = findViewById(R.id.sem5_4);
        m5 = findViewById(R.id.sem5_5);
        m6 = findViewById(R.id.sem5_6);
        m7 = findViewById(R.id.sem5_7);
        m8 = findViewById(R.id.sem5_8);
        m9 = findViewById(R.id.sem5_9);
        calc = findViewById(R.id.calc_sem5);
        reset = findViewById(R.id.reset_sem5);
        ...
        calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sgpa = (float) ((n1*3 + n2*4 + n3*4 + n4*3 + n5*3 + n6*3 + n7*2 + n8*2 + n9*1)/25.0);
                String result = String.format(Locale.US,"%.2f",sgpa);

                Bundle bundle = new Bundle();
                bundle.putString("name", "SGPA for 5th SEM");
