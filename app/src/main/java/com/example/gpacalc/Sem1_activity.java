...
public class Sem1_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m4 = findViewById(R.id.sem1_4);
        m5 = findViewById(R.id.sem1_5);
        m6 = findViewById(R.id.sem1_6);
        m7 = findViewById(R.id.sem1_7);
        m8 = findViewById(R.id.sem1_8);
        calc = findViewById(R.id.calc_sem1);
        reset = findViewById(R.id.reset_sem1);
