...
public class Sem3_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m1 = findViewById(R.id.sem3_1);
        m2 = findViewById(R.id.sem3_2);
        m3 = findViewById(R.id.sem3_3);
        m4 = findViewById(R.id.sem3_4);
        m5 = findViewById(R.id.sem3_5);
        m6 = findViewById(R.id.sem3_6);
        m7 = findViewById(R.id.sem3_7);
        m8 = findViewById(R.id.sem3_8);
        m9 = findViewById(R.id.sem3_9);
        calc = findViewById(R.id.calc_sem3);
        reset = findViewById(R.id.reset_sem3);
        ...
        calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("name", "SGPA for 3rd SEM");
