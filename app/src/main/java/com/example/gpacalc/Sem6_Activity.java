...
public class Sem6_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m1 = findViewById(R.id.sem6_1);
        m2 = findViewById(R.id.sem6_2);
        m3 = findViewById(R.id.sem6_3);
        m4 = findViewById(R.id.sem6_4);
        m5 = findViewById(R.id.sem6_5);
        m6 = findViewById(R.id.sem6_6);
        m7 = findViewById(R.id.sem6_7);
        m8 = findViewById(R.id.sem6_8);
        calc = findViewById(R.id.calc_sem6);
        reset = findViewById(R.id.reset_sem6);
        ...
        calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sgpa = (float) ((n1*4 + n2*4 + n3*4 + n4*3 + n5*3 + n6*2 + n7*2 + n8*2)/24.0);
                String result = String.format(Locale.US,"%.2f",sgpa);

                Bundle bundle = new Bundle();
                bundle.putString("name", "SGPA for 6th SEM");
